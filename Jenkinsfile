...
node {
    ...
    stage('Build') {
      ...
      docker.image('sonarsource/sonar-scanner-cli').inside('-e SONAR_HOST_URL=http://52.82.10.96:9000 -e SONAR_LOGIN=718e7ca6ed91dfe1b706cce2339ea89fc4ab6f02 -it -v "$PWD/:/usr/src"') {
